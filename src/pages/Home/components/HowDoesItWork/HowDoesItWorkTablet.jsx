  ...
  return (
    ...
    <div className="hdw-tablet">
      ...
      <div className="hdw-content">
        <h2 className="h2-32">Step 3. Transfers to people from your contact list</h2>
        <p className="bd-text pt-2">Proin volutpat mollis egestas. Nam luctus facilisis ultrices.
...
export default HowDoesItWorkTablet